...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-menu">
            <li><a href="<?php echo base_url('admin/suratkematian'); ?>"><i class="fas fa-file-alt"></i> Surat Kematian</a></li>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">
                    <?php echo isset($is_edit) && $is_edit ? 'Perbarui data surat kelahiran' : 'Isi formulir dengan data yang benar dan lengkap'; ?>
                </p>
            </div>
            <a href="<?php echo base_url('admin/suratkelahiran'); ?>" class="btn-back">
        ...
        <div class="form-container">
            <div class="form-header">
                <h2><i class="fas fa-edit"></i> <?php echo isset($is_edit) && $is_edit ? 'Form Edit Surat Kelahiran' : 'Formulir Surat Keterangan Kelahiran'; ?></h2>
                <p>Silakan lengkapi semua data dengan informasi yang akurat</p>
            </div>

            <div class="form-body">
                <form action="<?php echo isset($is_edit) && $is_edit ? base_url('admin/suratkelahiran/update/' . $surat->id) : base_url('admin/suratkelahiran/store'); ?>" method="POST">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label>Hari Lahir <span class="required">*</span></label>
                                <div class="input-icon">
                                    <input type="text" name="hari_lahir" id="hari"
                                        value="<?php echo isset($surat) ? $surat->hari_lahir : set_value('hari_lahir'); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="date" name="tanggal_lahir" id="tgl"
                                        value="<?php echo isset($surat) ? $surat->tanggal_lahir : set_value('tanggal_lahir'); ?>"
                                        required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label>Pukul Lahir <span class="required">*</span></label>
                                <div class="input-icon">
                                    <input type="time" name="pukul_lahir"
                                        value="<?php echo isset($surat) ? $surat->pukul_lahir : set_value('pukul_lahir'); ?>"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" name="tempat_lahir"
                                        value="<?php echo isset($surat) ? $surat->tempat_lahir : set_value('tempat_lahir'); ?>"
                                        placeholder="Rumah Sakit/Klinik" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                <label>Nama Lengkap Bayi <span class="required">*</span></label>
                                <div class="input-icon">
                                    <input type="text" name="nama_bayi"
                                        value="<?php echo isset($surat) ? $surat->nama_bayi : set_value('nama_bayi'); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <select name="jenis_kelamin_bayi" required>
                                        <option value="">Pilih Jenis Kelamin</option>
                                        <option value="Laki-laki" <?php echo (isset($surat) && $surat->jenis_kelamin_bayi == 'Laki-laki') || set_select('jenis_kelamin_bayi', 'Laki-laki') ? 'selected' : ''; ?>>Laki-laki</option>
                                        <option value="Perempuan" <?php echo (isset($surat) && $surat->jenis_kelamin_bayi == 'Perempuan') || set_select('jenis_kelamin_bayi', 'Perempuan') ? 'selected' : ''; ?>>Perempuan</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group full-width">
                                ...
                                <div class="input-icon">
                                    <input type="text" name="nama_ibu"
                                        value="<?php echo isset($surat) ? $surat->nama_ibu : set_value('nama_ibu'); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" name="nik_ibu"
                                        value="<?php echo isset($surat) ? $surat->nik_ibu : set_value('nik_ibu'); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="number" name="umur_ibu"
                                        value="<?php echo isset($surat) ? $surat->umur_ibu : set_value('umur_ibu'); ?>"
                                        placeholder="Umur ibu" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" name="pekerjaan_ibu"
                                        value="<?php echo isset($surat) ? $surat->pekerjaan_ibu : set_value('pekerjaan_ibu'); ?>"
                                        placeholder="Pekerjaan ibu" required>
                                </div>
                            </div>

                            <div class="form-group full-width">
                                <label>Alamat Lengkap Ibu <span class="required">*</span></label>
                                <textarea name="alamat_ibu" placeholder="Masukkan alamat lengkap ibu" required><?php echo isset($surat) ? $surat->alamat_ibu : set_value('alamat_ibu'); ?></textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group full-width">
                                ...
                                <div class="input-icon">
                                    <input type="text" name="nama_ayah"
                                        value="<?php echo isset($surat) ? $surat->nama_ayah : set_value('nama_ayah'); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" name="nik_ayah"
                                        value="<?php echo isset($surat) ? $surat->nik_ayah : set_value('nik_ayah'); ?>"
                                        placeholder="16 digit NIK" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="number" name="umur_ayah"
                                        value="<?php echo isset($surat) ? $surat->umur_ayah : set_value('umur_ayah'); ?>"
                                        placeholder="Umur ayah" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" name="pekerjaan_ayah"
                                        value="<?php echo isset($surat) ? $surat->pekerjaan_ayah : set_value('pekerjaan_ayah'); ?>"
                                        placeholder="Pekerjaan ayah" required>
                                </div>
                            </div>

                            <div class="form-group full-width">
                                <label>Alamat Lengkap Ayah <span class="required">*</span></label>
                                <textarea name="alamat_ayah" placeholder="Masukkan alamat lengkap ayah" required><?php echo isset($surat) ? $surat->alamat_ayah : set_value('alamat_ayah'); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" name="pekerjaan_pelapor"
                                        ...
                                        placeholder="Pekerjaan pelapor" required>
                                </div>
                            </div>

                            <div class="form-group full-width">
                                <label>Alamat Lengkap Pelapor <span class="required">*</span></label>
                            ...
                            <div class="form-group full-width">
                                <label>Hubungan Pelapor dengan Bayi <span class="required">*</span></label>
                                <div class="input-icon">
                                    <input type="text" name="hubungan_pelapor"
                                        value="<?php echo isset($surat) ? $surat->hubungan_pelapor : set_value('hubungan_pelapor'); ?>"
                                        placeholder="Contoh: Ayah Kandung, Ibu Kandung, Saudara" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Penandatangan -->
                    <div class="form-section">
                        <div class="section-title" style="color: #8e24aa;">
                            <i class="fas fa-signature" style="background: linear-gradient(135deg, #ab47bc 0%, #8e24aa 100%);"></i>
                    ...
                    <!-- Buttons -->
                    <div class="btn-group">
                        <a href="<?php echo base_url('admin/suratkelahiran'); ?>" class="btn btn-secondary">
        ...
        <div style="text-align: center; padding: 30px; color: #666; font-size: 13px;">
            © 2026 <span style="color: #ec407a; font-weight: 600;">SIMPEL AWET</span> - Kelurahan Kalinyamat Wetan
        </div>
