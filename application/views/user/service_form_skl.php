                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="upload_aktan" class="form-label">Buku Nikah Orang Tua (pdf/jpg/png)</label>
                                <input type="file" class="form-control" id="upload_aktan" name="upload_aktan" required>
                            </div>
                            <div class="mb-3">
                                <label for="upload_kk" class="form-label">Kartu Keluarga (pdf/jpg/png)</label>
                                <input type="file" class="form-control" id="upload_kk" name="upload_kk" required>
                            </div>
                            <div class="mb-3">
                                <label for="upload_ktp" class="form-label">KTP Orang Tua (pdf/jpg/png)</label>
                            ...
                            <div class="mb-3">
                                <label for="upload_suketdok" class="form-label">Surat Keterangan Dokter (Jika Lahir di Rumah Sakit) (pdf/jpg/png)</label>
