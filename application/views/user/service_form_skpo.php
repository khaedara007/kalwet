                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="additional_notes" class="form-label">Tujuan Permohonan (Cantumkan Penghasilan Orang Tua dan Untuk Keperluan Apa)</label>
                            ...
                            <div class="mb-3">
                                <label for="upload_ktp" class="form-label">KTP (pdf/jpg/png)</label>
