                    ...
                    <div class="form-card-body">
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="additional_notes" name="additional_notes" rows="2" placeholder="Contoh: Untuk mengurus perbankan, urusan waris, dll"></textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">
                                        <i class="bi bi-person-vcard-fill"></i>Akta Kelahiran
                                        <span class="required-badge">*</span>
                                    </label>
                                    <div class="file-upload-wrapper">
                                        <i class="bi bi-cloud-arrow-up"></i>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">
                                        <i class="bi bi-person-vcard-fill"></i>Akta / Buku Nikah (Jika Sudah Menikah)
                                        <span class="required-badge"></span>
                                    </label>
                                    <div class="file-upload-wrapper">
                                        <i class="bi bi-cloud-arrow-up"></i>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">
                                        <i class="bi bi-person-vcard-fill"></i>Berkas Identitas Yang Berbeda
                                        <span class="required-badge">*</span>
                                    </label>
                                    <div class="file-upload-wrapper">
                                        <i class="bi bi-cloud-arrow-up"></i>
